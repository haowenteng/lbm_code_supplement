...
classdef cylinder< handle   
    ...
    methods
        function obj = cylinder()   % constructor
        ...
        function initialize_geometry(obj)  % initialize the geometry
        ...
        function init(obj)    % initialize the distribution function
        ...
        function collide(obj) % collision step
            for counter = 1:obj.NUM
                if obj.geometry(counter) == 1
        ...
        function update_bounce_back(obj)  % bounce-back nodes
            for counter = 1:length(obj.bb_nodes)
        ...
        function stream(obj)  % streaming step
            for counter = 1:obj.NUM
                if obj.geometry(counter) == 1
                    for iPop = 1:obj.NPOP
        ...
        function run_simulation(obj)    % run the simulation
            ...
            for counter = 1:obj.N
                ...
                if mod(counter, obj.NOUTPUT) == 0
                    ...
                    %obj = obj.writedensity(filewritedensity);
                end
            end
