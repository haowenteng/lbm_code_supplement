%% done
% filepath: d:\BaiduSyncdisk\VScode\Books\lbm_kruger\lbm_kruger_matlab_supply\cha8\film_antibb\main.m
% 创建 film_antibb 对象并运行模拟
sim = film_antibb();
sim.run_simulation() ;
%
%% 设置文件路径和文件名格式
file_path = '';
file_format = 'film_antibbfilm_antibb%07d.dat';
start_frame = 0;
end_frame = 6700;
frame_step = 100;
...
% 创建视频对象
video = VideoWriter('film_antibb_simulation.avi');
open(video);
